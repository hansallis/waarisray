...
type BackendMsg
    = NoOpBackendMsg
    | Tick Time.Posix
    | GotImageGenerationResult String (Result ( Http.Error, String ) { images : List String, error : Maybe String }) -- userName, result (with response body on error)
